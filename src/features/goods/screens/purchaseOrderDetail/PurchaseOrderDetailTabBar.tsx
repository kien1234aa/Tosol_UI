...
import { PO_DETAIL_TABS } from './poDetailTypes';

export type PurchaseOrderDetailTabBarProps = {
  tabs?: typeof PO_DETAIL_TABS;
  activeTab: PurchaseOrderDetailTabId;
  itemCount: number;
  onSelectTab: (id: PurchaseOrderDetailTabId) => void;
};

export function PurchaseOrderDetailTabBar({
  tabs = PO_DETAIL_TABS,
  activeTab,
  itemCount,
  onSelectTab,
}: PurchaseOrderDetailTabBarProps) {
  const styles = useThemeStyleSheet(create_PurchaseOrderDetailTabBar_styles);
...
function create_PurchaseOrderDetailTabBar_styles(c: AppColorPalette) {
