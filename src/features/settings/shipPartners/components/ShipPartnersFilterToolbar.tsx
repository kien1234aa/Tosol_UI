...
export type ShipPartnersFilterToolbarProps = {
  query: string;
...
export function ShipPartnersFilterToolbar({
  query,
  onQueryChange,
  statusFilter,
  ...
  primaryActionTitle,
  onPrimaryAction,
}: ShipPartnersFilterToolbarProps) {
  ...
  return (
    <>
      <ListScreenSearchToolbar
        ...
        searchPlaceholder="Tìm theo tên đối tác, mã…"
