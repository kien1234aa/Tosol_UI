...
export type ServicePricingsFilterToolbarProps = {
  query: string;
...
export function ServicePricingsFilterToolbar({
  query,
  onQueryChange,
  statusFilter,
  ...
  primaryActionTitle,
  onPrimaryAction,
}: ServicePricingsFilterToolbarProps) {
  ...
  return (
    <>
      <ListScreenSearchToolbar
        ...
        searchPlaceholder="Tìm theo tên, loại dịch vụ…"
