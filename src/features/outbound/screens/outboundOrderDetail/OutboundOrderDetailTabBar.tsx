...
import { OUTBOUND_ORDER_DETAIL_TABS } from './outboundOrderDetailTypes';

export type OutboundOrderDetailTabBarProps = {
  tabs?: typeof OUTBOUND_ORDER_DETAIL_TABS;
  activeTab: OutboundOrderDetailTabId;
  itemCount: number;
  onSelectTab: (id: OutboundOrderDetailTabId) => void;
};

export function OutboundOrderDetailTabBar({
  tabs = OUTBOUND_ORDER_DETAIL_TABS,
  activeTab,
  itemCount,
  onSelectTab,
}: OutboundOrderDetailTabBarProps) {
  const styles = useThemeStyleSheet(create_OutboundOrderDetailTabBar_styles);
...
function create_OutboundOrderDetailTabBar_styles(c: AppColorPalette) {
