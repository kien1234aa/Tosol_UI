...
import { dateToIsoDateOnly } from './components/datePickerUtils';

export type CreatePriceListScreenProps = {
  onOpenDrawer: () => void;
  onBack: () => void;
};

export function CreatePriceListScreen({
  onOpenDrawer,
  onBack,
}: CreatePriceListScreenProps) {
  const palette = useAppColors();
  const styles = useThemeStyleSheet(create_CreatePriceListScreen_styles);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      toast.success(`Đã tạo bảng giá ${created.name}`);
      onBack();
    } catch (e: unknown) {
  ...
  return (
    <View style={styles.root}>
      ...
      <KeyboardAvoidingView style={styles.flex} behavior="padding">
        ...
        >
          <FormScreenHeading sectionLabel="Bảng giá" title="Tạo bảng giá mới" />
...
function create_CreatePriceListScreen_styles(c: AppColorPalette) {
